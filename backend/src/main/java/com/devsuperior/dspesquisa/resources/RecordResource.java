...
public class RecordResource {
	...
	@Autowired
	private RecordService serviceRecord;
	
	@PostMapping
	public ResponseEntity<RecordDTO> insert(@RequestBody RecordInsertDTO recordInsertDTO){
		
		RecordDTO newRecordDTO= serviceRecord.insert(recordInsertDTO);
	...
	public ResponseEntity<Page<RecordDTO>> findAll(
		...
		Page<RecordDTO> list= serviceRecord.findByMoments(minDate, maxDate, pageRequest);
